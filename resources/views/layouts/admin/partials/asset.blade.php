        ...
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.bundle.min.js" crossorigin="anonymous" defer></script>
        <script src="{{ asset('admin-assets/js/scripts.js') }}" defer></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous" defer></script>
        <script src="{{ asset('admin-assets/assets/demo/chart-area-demo.js') }}" defer></script>
        <script src="{{ asset('admin-assets/assets/demo/chart-bar-demo.js') }}" defer></script>
        ...
        <script src="{{ asset('admin-assets/assets/demo/datatables-demo.js') }}" defer></script>